...
h = 0.5+0.05/2; % altezza asta verticale + altezza del mezzo giunto prismatico (non consideriamo mezza altezza del piatto poichè l'asta verticale entra dentro esso)
...
% Initial condition: [l1 l2 l1_dot l2_dot wx wy wz thetax thetay thetaz R11 , ... , R33]
l10 =  1-0.9; 
l1_dot0 = 0;
